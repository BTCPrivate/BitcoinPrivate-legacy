...
typedef enum zcashconsensus_error_t
{
    ...
    zcashconsensus_ERR_AMOUNT_REQUIRED,
    zcashconsensus_ERR_INVALID_FLAGS,
...
enum
{
    ...
    zcashconsensus_SCRIPT_FLAGS_VERIFY_NULLDUMMY           = (1U << 4), // enforce NULLDUMMY (BIP147)
    zcashconsensus_SCRIPT_FLAGS_VERIFY_CHECKLOCKTIMEVERIFY = (1U << 9), // enable CHECKLOCKTIMEVERIFY (BIP65)
    zcashconsensus_SCRIPT_FLAGS_VERIFY_CHECKSEQUENCEVERIFY = (1U << 10), // enable CHECKSEQUENCEVERIFY (BIP112)
    zcashconsensus_SCRIPT_FLAGS_VERIFY_WITNESS             = (1U << 11), // enable WITNESS (BIP141)
    zcashconsensus_SCRIPT_FLAGS_VERIFY_ALL                 = zcashconsensus_SCRIPT_FLAGS_VERIFY_P2SH | zcashconsensus_SCRIPT_FLAGS_VERIFY_DERSIG |
                                                               zcashconsensus_SCRIPT_FLAGS_VERIFY_NULLDUMMY | zcashconsensus_SCRIPT_FLAGS_VERIFY_CHECKLOCKTIMEVERIFY |
                                                               zcashconsensus_SCRIPT_FLAGS_VERIFY_CHECKSEQUENCEVERIFY | zcashconsensus_SCRIPT_FLAGS_VERIFY_WITNESS
};
...
EXPORT_SYMBOL int zcashconsensus_verify_script_with_amount(const unsigned char *scriptPubKey, unsigned int scriptPubKeyLen, int64_t amount,
                                    const unsigned char *txTo        , unsigned int txToLen,
                                    unsigned int nIn, unsigned int flags, zcashconsensus_error* err);
