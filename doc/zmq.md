...
For instance:
    ...
    $ btcpd -zmqpubhashtx=tcp://127.0.0.1:28332 \
               -zmqpubrawtx=ipc:///tmp/btcpd.tx.raw
...
From the perspective of btcpd, the ZeroMQ socket is write-only; PUB
sockets don't even have a read function. Thus, there is no state
introduced into btcpd directly. Furthermore, no information is
...
using. btcpd appends an up-counting sequence number to each
